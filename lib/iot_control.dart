    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text('LDR Value: $ldrValue',style: TextStyle(fontSize: 20),),
            Text('Soil Moisture Value: $soilMoistureValue',style: TextStyle(fontSize: 20)),
            Text('Temperature Value: $temperatureValue',style: TextStyle(fontSize: 20)),
            Text('Smoke Value: $smokeValue',style: TextStyle(fontSize: 20)),
          ],
        ),
      ),
    );
