...
class HomePage extends StatelessWidget {
  ...
  List<Widget> buildCircularIcons(BuildContext context) {
    ...
    for (int i = 0; i < imagePaths.length; i++) {
      ...
      iconWidgets.add(
        Positioned(
          right: MediaQuery.of(context).size.width / 2 - x - 50, // Adjust icon size and positioning
          top: MediaQuery.of(context).size.height / 2 + y - 50, // Adjust icon size and positioning
